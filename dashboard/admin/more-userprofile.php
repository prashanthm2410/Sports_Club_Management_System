...
if(isset($_POST['submit'])) {
    ...
    $checkQuery = "SELECT * FROM admin WHERE username = '$user_id'";
    $checkResult = mysqli_query($con, $checkQuery);

    if(mysqli_num_rows($checkResult) > 0) {
        // If user exists, perform an update
        $query = "UPDATE admin SET Full_name = '$full_name', securekey = '$secure_key', pass_key = '$pass_key' WHERE username = '$user_id'";
    } else {
        // If user doesn't exist, perform an insert
        $query = "INSERT INTO admin (username, Full_name, securekey, pass_key) VALUES ('$user_id', '$full_name', '$secure_key', '$pass_key')";
    }
...
<body class="page-body page-fade" onload="collapseSidebar()">
    <div class="page-container sidebar-collapsed" id="navbarcollapse">
        ...
        <div class="main-content">
            ...
            <h3>Edit or Add User profile</h3>
            <p>(You will be required to Login Again After Profile Addition Or Updation)</p>
            <hr />
                                ...
                                <td height="35">
                                    <table width="100%" border="0" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td height="35">
                                                <input type="text" name="secure_key" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="35">PASSWORD:</td>
                                            <td height="35">
                                                <input type="password" name="pass_key" class="form-control" required>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td height="35">&nbsp;</td>

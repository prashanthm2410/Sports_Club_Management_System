    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
    		...
    		<div class="main-content">
				...
				<h2 class="sports-club-heading">SPORTS CLUB</h2>
					...
					<div class="icon"><i class="entypo-users"></i></div>
						...
						<?php
							...
							if (mysqli_affected_rows($con) != 0) {
							 ...
							 echo '<span class="revenue-display">₹'.$revenue.'</span>';
							?>
						</div>
				</div></a>
			</div>
			...
			<div class="col-sm-3"><a href="table_view.php">			
				<div class="tile-stats tile-green">
					<div class="icon"><i class="entypo-chart-bar"></i></div>
                        ...
                        if (mysqli_affected_rows($con) != 0) {
                            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                        echo '<span class="your-class">' . $row['COUNT(*)'] . '</span>';
                            }
                        }
                        $i = 1;
                        ?>
			...
			<div class="col-sm-3"><a href="over_members_month.php">			
				<div class="tile-stats tile-aqua">
					<div class="icon"><i class="entypo-mail"></i></div>
                       ...
                       if (mysqli_affected_rows($con) != 0) {
                           while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                               echo '<span class="our-class">' . $row['COUNT(*)'] . '</span>';
                           }
                       }
                       $i = 1;
                       ?>
			...
			<div class="col-sm-3"><a href="view_plan.php">			
				<div class="tile-stats tile-blue">
					<div class="icon"><i class="entypo-rss"></i></div>
                        ...
                        if (mysqli_affected_rows($con) != 0) {
                                                                            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                echo '<span class="my-class">' . $row['COUNT(*)'] . '</span>';
                            }
                        }
                        $i = 1;
                        ?>
...
<marquee direction="right"><img src="fball.jpg" width="88" height="70" alt="Tutorials " border="0"></marquee>

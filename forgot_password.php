...
<body class="page-body login-page login-form-fall" style="background-color: lavender;">
    <div id="container">
                    ...
                    <form action="change_s_pwd.php" method="POST" id="bb">    
                        ...
                        <div class="form-group">                    
                            <div class="input-group">
                                ...
                                <input type="password" name="pwfield" id="pwfield" class="form-control" data-rule-required="true" data-rule-minlength="6" placeholder="Your new password">
                            </div>                
                        </div>
